...
Scenario: Creating a stripe pattern
  Given pattern ← new stripe_pattern(white, black)
...
Scenario: Stripes with an object transformation
  Given object ← new sphere
    ...
    And pattern ← new stripe_pattern(white, black)
...
#  Given pattern ← new gradient_pattern(white, black)
...
#  Given pattern ← new ring_pattern(white, black)
#  Then pattern_at(pattern, point 0, 0, 0) = white
...
#  Given pattern ← new checkers_pattern(white, black)
#  Then pattern_at(pattern, point 0, 0, 0) = white
